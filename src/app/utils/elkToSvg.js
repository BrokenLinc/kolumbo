...
Renderer.prototype = {
  ...
  renderRoot(root, styles = "DEFAULT", defs = "DEFAULT") {
    ...
    if (styles != null || defs != null) {
      if (styles != null) {
        defsChildren.push(
          this.svgCss(styles == "DEFAULT" ? this._style : styles)
        );
      }
      if (defs != null) {
  ...
  renderEdge(edge, node) {
    ...
    if (
      this._edgeRoutingStyle[node.id] == "SPLINES" ||
      this._edgeRoutingStyle.__global == "SPLINES"
    ) {
  ...
  svgCss(css) {
    ...
    return new Xml("style", { type: "text/css" }, [new Cdata(new Text(css))]);
  },
